...
A blazingly slow small plugin for bringing implementations into the foreground for structs and interfaces.
...
- [nvim-treesitter](https://github.com/nvim-treesitter/nvim-treesitter/)
  Make sure the `go` parser is installed.

## 📦 Installation

Install the plugin with your package manager:

### [Gompli](https://github.com/maxandron/gompli.nvim)
